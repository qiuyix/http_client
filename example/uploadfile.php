...
/**
 * 上传文件, 如果文件不存在，或者filedName未设置会抛出异常
 * @param string 字段名，按要求填写
 * @param string 上传文件路径，推荐绝对路径
 * @param string 如果需要指定上传文件类型，可在此处传值
 * @throw \Exception
 */
$handle->uploadFile("fileName", "filepath", "mimeType");
